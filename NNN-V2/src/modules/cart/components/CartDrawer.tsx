...
// checkout CTA). Rendered full-bleed on the /cart page. Kept as its own
// component (rather than inlined in the page) so it can also be reused as
// a true slide-in overlay elsewhere without duplicating cart-summary logic.
// ============================================================================
  ...
  return (
    <div className="flex flex-col">
      ...
      {showContinueShopping && (
        <Link
          href="/menu"
          className="mx-4 sm:mx-0 mt-2 text-sm font-medium text-brand-500 hover:text-brand-600"
        >
          + Add more items
        </Link>
      )}

      <div className="mt-6 mx-4 sm:mx-0 rounded-xl2 border border-ink-100 bg-cream-100 p-4 flex flex-col gap-2">
